...
namespace QLDSV_TC
{
    public partial class frmDSSVDK : Form
    {
        public frmDSSVDK()
        {
            InitializeComponent();
        ...
        private void frmDSSVDK_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            XrptDSSVDK rpt = new XrptDSSVDK(nienKhoa,hocKy,maMon,nhom);
